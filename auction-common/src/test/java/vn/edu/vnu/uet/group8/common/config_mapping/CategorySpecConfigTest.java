...
class CategorySpecConfigTest {
  ...
  class GetRequiredSpecsTest {
    ...
    void categoryNull() {
      List<SpecKey> result = CategorySpecConfig.getRequiredSpecs(null);
    ...
    void watches() {
      List<SpecKey> specs = CategorySpecConfig.getRequiredSpecs(ItemCategory.WATCHES);
    ...
    void electronics() {
      List<SpecKey> specs = CategorySpecConfig.getRequiredSpecs(ItemCategory.ELECTRONICS);
      assertTrue(specs.contains(SpecKey.BRAND));
      assertTrue(specs.contains(SpecKey.MODEL));
    ...
    void categoryKhongConfig() {
      List<SpecKey> specs = CategorySpecConfig.getRequiredSpecs(ItemCategory.OTHER);
    ...
    void tatCaCategory() {
      for (ItemCategory cat : ItemCategory.values()) {
        assertNotNull(CategorySpecConfig.getRequiredSpecs(cat));
      }
    }
  }
  ...
  class GetSpecFieldsTest {
    ...
    void watchesFields() {
      List<String> fields = CategorySpecConfig.getSpecFields(ItemCategory.WATCHES);
    ...
    void categoryNull() {
      List<String> fields = CategorySpecConfig.getSpecFields(null);
    ...
    void other() {
      List<String> fields = CategorySpecConfig.getSpecFields(ItemCategory.OTHER);
      assertTrue(fields.isEmpty());
    }
  }
}