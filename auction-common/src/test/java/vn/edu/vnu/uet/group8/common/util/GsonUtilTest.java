...
/**
 * Test cho {@link GsonUtil} - test custom Instant adapter.
 */
class GsonUtilTest {
    ...
    class InstantTest {
        ...
        void serialize() {
            ...
            // Gson serialize string với quotes
            assertTrue(json.contains("2026-01-15T10:30:00Z"),
                    "JSON phải chứa ISO-8601 string");
        }
    ...
    class DtoTest {
        ...
        void roundtripDto() {
            Sample original = new Sample("iPhone", Instant.parse("2026-01-01T00:00:00Z"),
                    new BigDecimal("100"));
            String json = GsonUtil.GSON.toJson(original);
