...
class AuctionDetailControllerTest extends FxTestBase {
    ...
    void setup() {
        ...
        controller.lblCategory    = new Label();
        controller.lblCurrentPrice= new Label();
        controller.lblMinBid      = new Label();
        controller.lblDescription = new Label();
        controller.lblCertificate = new Label();
        controller.lblHours       = new Label();
        controller.lblMinutes     = new Label();
        controller.lblSeconds     = new Label();
        controller.tfBidAmount    = new TextField();
        controller.tfMaxPrice     = new TextField();
        controller.bidHistory     = new VBox();
        controller.paneAuto       = new VBox();
        controller.btnAutoToggle  = new Button("Auto");
        controller.btnTabDesc     = new Button();
        controller.btnTabSpec     = new Button();
        controller.btnTabOrigin   = new Button();
    }

    @Nested @DisplayName("setTimeDisplay")
    class SetTimeDisplay {

        @Test @DisplayName("0h 0m 0s → labels = '00'")
        void all_zero() {
        ...
        @Test @DisplayName("1h 30m 5s → '01', '30', '05'")
        ...
        @Test @DisplayName("lblHours null → không crash")
        void null_labels_no_crash() {
            controller.lblHours = null;
            controller.lblMinutes = null;
            controller.lblSeconds = null;
            assertDoesNotThrow(() -> controller.setTimeDisplay(1, 1, 1));
        }
    }

    @Nested @DisplayName("onToggleAuto")
    class ToggleAuto {

        @Test @DisplayName("pane ban đầu ẩn → toggle hiện ra")
        ...
        @Test @DisplayName("pane hiện → toggle ẩn lại")
        ...
        @Test @DisplayName("paneAuto null → không crash")
    ...
    @Nested @DisplayName("cleanup")
    class Cleanup {

        @Test @DisplayName("cleanup khi countdown null → không crash")
        void null_countdown_no_crash() {
            assertDoesNotThrow(() -> controller.cleanup());
        }
    }

    @Nested @DisplayName("displayItemInfo – null item")
    class DisplayItemInfo {

        @Test @DisplayName("currentItem null → label giữ nguyên mặc định")
        void null_item_no_crash() {
            // loadItemFromModel sẽ gọi displayItemInfo chỉ khi currentItem != null
