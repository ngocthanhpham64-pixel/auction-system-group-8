...
class RegisterServiceTest {
    ...
    class CheckDuplicate {
        ...
        void usernameTrung() throws SQLException {
            ...
            when(userDAO.existsByUsername(USERNAME))
                    .thenReturn(true);
        ...
        void phoneTrung() throws SQLException {
            ...
            when(userDAO.existsByPhone(PHONE))
                    .thenReturn(true);
    ...
    class Success {
        ...
        void thanhCong() throws SQLException {
            ...
            doAnswer(invocation -> {
                ...
                user.assignId(42);
                return null;
            }).when(userDAO).insert(any(UserMember.class));

            UserSummaryDTO dto = registerService.register(
                    USERNAME,
                    EMAIL,
                    PASSWORD,
                    FULLNAME,
        ...
        void normalize() throws SQLException {
            ...
            when(userDAO.existsByUsername("quan123"))
                    .thenReturn(false);

            when(userDAO.existsByEmail("quan@example.com"))
                    .thenReturn(false);
