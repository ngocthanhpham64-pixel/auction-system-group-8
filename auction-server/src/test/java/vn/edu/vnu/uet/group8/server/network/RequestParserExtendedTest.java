...
class RequestParserExtendedTest {
    ...
    class RequireIntTest {
        ...
        @Test @DisplayName("field có giá trị int → trả đúng")
        void coInt() {
        ...
        @Test @DisplayName("field có giá trị 0 → trả 0")
        void zero() {
            JsonObject r = new JsonObject();
        ...
        @Test @DisplayName("field âm → trả giá trị âm")
        void negative() {
            JsonObject r = new JsonObject();
            r.addProperty("val", -5);
        ...
        @Test @DisplayName("field không tồn tại → ValidationException")
        void fieldMissing() {
            assertThrows(ValidationException.class, () ->
                    RequestParser.requireInt(new JsonObject(), "missing"));
        }

        @Test @DisplayName("field là JsonNull → ValidationException")
        void fieldNull() {
            JsonObject r = new JsonObject();
    ...
    class OptionalIntTest {
        ...
        @Test @DisplayName("field có giá trị → trả đúng")
        void coInt() {
            JsonObject r = new JsonObject();
        ...
        @Test @DisplayName("field không tồn tại → null")
        void fieldMissing() {
            assertNull(RequestParser.optionalInt(new JsonObject(), "missing"));
        }

        @Test @DisplayName("field là JsonNull → null")
        void fieldJsonNull() {
            JsonObject r = new JsonObject();
            r.addProperty("val", (Integer) null);
    ...
    class RequireMapTest {
        ...
        @Test @DisplayName("field là JsonObject hợp lệ → trả Map đúng")
        void hopLe() {
        ...
        @Test @DisplayName("field là JsonObject rỗng → trả Map rỗng")
        void emptyObject() {
            JsonObject r = new JsonObject();
        ...
        @Test @DisplayName("field là JsonArray (không phải Object) → ValidationException")
        void fieldIsArray() {
            JsonObject r = new JsonObject();
        ...
        @Test @DisplayName("field là primitive string → ValidationException")
    ...
    class OptionalMapTest {
        ...
        @Test @DisplayName("field không tồn tại → Map rỗng")
        void fieldMissing() {
        ...
        @Test @DisplayName("field là JsonNull → Map rỗng")
        void fieldNull() {
            JsonObject r = new JsonObject();
        ...
        @Test @DisplayName("field là JsonArray → ValidationException")
        void fieldIsArray() {
            JsonObject r = new JsonObject();
        ...
        @Test @DisplayName("field là primitive → ValidationException")
        void fieldIsPrimitive() {
            JsonObject r = new JsonObject();
        ...
        @Test @DisplayName("optionalMap trả Map có thể đọc bình thường")
        void mapReadable() {
    ...
    class OptionalStringTest {
        ...
        @Test @DisplayName("field JsonNull → null")
        void jsonNull() {
            JsonObject r = new JsonObject();
        ...
        @Test @DisplayName("field rỗng string → trả chuỗi rỗng")
        void emptyString() {
            JsonObject r = new JsonObject();
            r.addProperty("name", "");
    ...
    class GetPayloadTest {
        ...
        @Test @DisplayName("payload là JsonPrimitive số → deserialize đúng kiểu")
        ...
        @Test @DisplayName("payload là JsonObject → deserialize sang DTO")
        ...
        @Test @DisplayName("payload null → trả null")
        void payloadMissing() {
            assertNull(RequestParser.getPayload(new JsonObject(), String.class));
        }

        @Test @DisplayName("payload sai kiểu nghiêm trọng → ValidationException")
