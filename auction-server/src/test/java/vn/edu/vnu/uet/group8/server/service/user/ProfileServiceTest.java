...
class ProfileServiceTest {
  ...
  private UserMember taoMember(int id) {
    UserMember m =
        new UserMember.Builder("user" + id, "u" + id + "@e.com", "hash")
            .fullname("User " + id)
            .phone("0912345678")
            .build();
    m.assignId(id);
  ...
  class GetProfile {
    ...
    void memberXemAdmin() throws SQLException {
      ...
      assertThrows(UserNotFoundException.class, () -> profileService.getProfile(10, 99));
    }
    ...
    void modXemSuperAdmin() throws SQLException {
      ...
      assertThrows(UserNotFoundException.class, () -> profileService.getProfile(50, 99));
    }
    ...
    void targetKhongTonTai() throws SQLException {
      ...
      assertThrows(UserNotFoundException.class, () -> profileService.getProfile(1, 999));
    }
  }
  ...
  class UpdateAuth {
    ...
    void tuSua() throws SQLException {
      ...
      assertDoesNotThrow(
          () -> profileService.updateProfile(1, 1, "New Name", "0912345678", "Hanoi", null));
    ...
    void coSuaNguoiKhac() throws SQLException {
      ...
      assertThrows(
          ...
          () -> profileService.updateProfile(1, 2, "Name", "0912345678", "Address", null));
    }
    ...
    void superAdminSua() throws SQLException {
      ...
      assertDoesNotThrow(
          () -> profileService.updateProfile(99, 5, "New Name", "0912345678", "Hanoi", null));
      verify(userDAO).updateProfile(any(UserMember.class));
    }
    ...
    void modSua() throws SQLException {
      ...
      assertThrows(
          UnauthorizedException.class,
          () -> profileService.updateProfile(50, 5, "Name", "0912345678", "Address", null));
    }
  }
  ...
  class UpdateValidate {
    ...
    void fullnameNull() throws SQLException {
      ...
      assertThrows(
          ...
          () -> profileService.updateProfile(1, 1, null, "0912345678", "Address", null));
    }
    ...
    void fullnameRong() throws SQLException {
      ...
      assertThrows(
          ValidationException.class,
          () -> profileService.updateProfile(1, 1, "   ", "0912345678", "Address", null));
    }
    ...
    void fullnameDaiQua() throws SQLException {
      ...
      assertThrows(
          ValidationException.class,
          () -> profileService.updateProfile(1, 1, tooLong, "0912345678", "Address", null));
    }
  }
