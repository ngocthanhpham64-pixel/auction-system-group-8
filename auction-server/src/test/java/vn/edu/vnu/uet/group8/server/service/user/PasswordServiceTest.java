...
class PasswordServiceTest {
  ...
  private UserMember taoMember(int id, String plainPassword) {
    UserMember m =
        new UserMember.Builder("alice", "a@e.com", PasswordUtil.hash(plainPassword)).build();
  ...
  class ChangePasswordTest {
    ...
    void userKhongTonTai() throws SQLException {
      ...
      assertThrows(
          ...
          () -> passwordService.changePassword(999, "old", "newPass123"));
    }
    ...
    void matKhauCuSai() throws SQLException {
      ...
      assertThrows(
          ...
          () -> passwordService.changePassword(1, "wrongOld", "newPass123"));
    }
    ...
    void matKhauMoiTrungCu() throws SQLException {
      ...
      ValidationException ex =
          assertThrows(
              ...
              () -> passwordService.changePassword(1, "samePass123", "samePass123"));
    ...
    void matKhauMoiNgan() throws SQLException {
      ...
      assertThrows(
          ...
          () -> passwordService.changePassword(1, "rightOld", "12"));
    }
    ...
    void doiThanhCong() throws SQLException {
      ...
      passwordService.changePassword(1, "oldPass123", "newPass456");

      verify(userDAO).updatePassword(eq(1), eq("newPass456"));
    }
    ...
    void matKhauMoiInvalidKhongUpdate() throws SQLException {
      ...
      try {
        passwordService.changePassword(1, "oldPass123", "123");
    ...
    void sqlExceptionPropagate() throws SQLException {
      ...
      assertThrows(
          SQLException.class, () -> passwordService.changePassword(1, "old", "newPass123"));
    }
  }
  ...
  class RequestOtpTest {
    ...
    void emailKhongTonTai() throws SQLException {
      when(userDAO.findByEmail("notexist@e.com")).thenReturn(Optional.empty());

      assertThrows(
          ValidationException.class,
          () -> passwordService.requestOtpForPasswordReset("notexist@e.com"));
    }
    ...
    void otpSinhRa() throws SQLException {
      ...
      when(userDAO.findByEmail("a@e.com")).thenReturn(Optional.of(user));

      String otp = passwordService.requestOtpForPasswordReset("a@e.com");

      assertNotNull(otp);
      assertEquals(6, otp.length(), "OTP phải đúng 6 ký tự");
      assertTrue(otp.matches("\\d{6}"), "OTP phải toàn số");
    }
    ...
    void emailNormalize() throws SQLException {
      ...
      verify(userDAO).findByEmail("a@e.com");
    }
  }
  ...
  class ResetWithOtpTest {
    ...
    void otpChuaRequest() {
      assertThrows(
          ValidationException.class,
          () -> passwordService.resetPasswordWithOtp("a@e.com", "123456", "newPass"));
    }
    ...
    void otpSai() throws SQLException {
      ...
      ValidationException ex =
          assertThrows(
              ValidationException.class,
              () -> passwordService.resetPasswordWithOtp("a@e.com", wrongOtp, "newPass456"));
    ...
    void otpDung() throws SQLException {
      ...
      passwordService.resetPasswordWithOtp("a@e.com", otp, "newValid123");
    ...
    void newPasswordKhongHopLe() throws SQLException {
      ...
      assertThrows(
          UserServiceException.class,
          () -> passwordService.resetPasswordWithOtp("a@e.com", otp, "ab"));
    }
  }
}