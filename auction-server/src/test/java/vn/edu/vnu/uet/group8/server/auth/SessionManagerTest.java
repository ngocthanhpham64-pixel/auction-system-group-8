 ...
 *
 * <p>Không cần mock - SessionManager dùng ConcurrentHashMap trong process,
 * test pure state machine.
 *
 * <p>Phạm vi:
 * <ul>
 *   <li>createSession - sinh token UUID + map userId
 *   <li>validateToken - trả userId nếu hợp lệ, -1 nếu không
 *   <li>invalidateToken / invalidateUser - logout
 *   <li>Single-session-per-user: login lại → token cũ bị xoá
 *   <li>activeSessionCount - đếm session đang active
 *   <li>Edge cases: token null, blank, không tồn tại
 * </ul>
 */
